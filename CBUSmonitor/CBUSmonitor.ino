...
#define TFTDISPLAY_WIDTH 48   // Width in characters 
...
typedef struct display_line {uint16_t text_colour; char text_data[48];};
...
// Readback test
  while (CAN.available())
  {
    ...
    disp_ptr += sprintf(disp_ptr, "%5d %03hx", msg_cnt, msg.id);    
  ...
  // sprintf(test_data, " %5d hhh oo dd dd dd dd dd dd dd dd", msg_cnt);
